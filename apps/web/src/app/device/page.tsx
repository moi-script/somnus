...
import { BluetoothIcon, ChevronIcon, ChipIcon } from '@/components/Icons';
...
export default function DevicePage() {
  const { devices, active, select, reload } = useDevice();
  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        <section className="card px-6 py-6">
          <h2 className="text-lg font-semibold">Add a band</h2>
          <p className="mt-1 text-muted">
            Switch it on and read the id from its first line of output.
          </p>
          ...
          {claimed && (
            <div className="mt-5 rounded-2xl bg-canvas px-4 py-4">
              ...
              <p className="mt-1 text-sm text-muted">
                Shown once. The phone app keeps it for you. For the USB bridge,
                put it in .env as BRIDGE_DEVICE_TOKEN.
              </p>
